...
namespace Camera.net
{
    public partial class MainWindow : Form
    {
        ...
        private unsafe void rgbRenderThread()
        {
            ...
            while (this.shouldRun)
            {
                lock (this)
                {
                    ...
                    this.depthCam.getDistanceForRGB();
                    this.bitmap.UnlockBits(data);
                    this.bitmap.RotateFlip(System.Drawing.RotateFlipType.RotateNoneFlipX);
                }
        ...
        void GetBitmap(Bitmap Bmp, Int16[] values)
        {
            ...
            //{
            //    Rectangle rect = new Rectangle(0, 0, this.bitmap.Width, this.bitmap.Height);
            //    BitmapData data2 = Bmp.LockBits(rect, ImageLockMode.WriteOnly, System.Drawing.Imaging.PixelFormat.Format24bppRgb);
            //    data2 = this.depthCam.getData(data2);
            //    this.bitmap.UnlockBits(data2);
            //    this.bitmap.RotateFlip(System.Drawing.RotateFlipType.RotateNoneFlipX);
            //}
