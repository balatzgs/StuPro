...
namespace Camera.net
{
    ...
    /// <summary>
    /// Wichtig ist die NewFrame() Methode
    /// Sobald PiConnect sagt es gibt ein neues Frame wird diese Methode automatisch aufgereufen
    /// Hier werden dann die Bitmaps erstellt
    ///und mit this.mainWindow.reenderImage(Bitmap bitmap) wird die zuvor erzeugte Bitmap gezeichnet
     /// </summary>
   public class ThermalCamera
    {
        private DepthCamera depthCam;
        private Bitmap bitmap;
        public Boolean showFusedImage;
        public Boolean showDepth;
        public Boolean showThermo;
        //........................................
        //Thermo Zeugs
#if _WIN64
        const Int32 OS = 64;
        ...
        public void setMainWindow(MainWindow mainWindow,DepthCamera depthCam)
        {
